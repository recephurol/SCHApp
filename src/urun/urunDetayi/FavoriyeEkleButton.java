...
public class FavoriyeEkleButton extends JButton {
    ...
    public void favoridenCikar() throws SQLException, IOException {
        PostgreSQLDbConnection db = new PostgreSQLDbConnection();
        db.baglan();
        db.favoridenCikar(this.urunId, this.kullaniciId);
        JOptionPane.showMessageDialog(null, "Ürün favorilerden basarili bir sekilde çıkarıldı");
        db.baglantiyiKapat();
    }
